...
rotate([0,0,0]) translate([80,10,40]) rotate([0,0,180])difference(){
    
    roundedRect([50, 56, 5], 5);
    translate([0,0,-1])  roundedRect([42, 46, 4], 5, $fn=99);
    translate([20,0,-1.69]) rotate([0,90,0]) cylinder(10,4.5,4.5); 
    translate([-20.50,24,2]) cylinder(r=2.5,h=10);
    translate([-13.50,24,2]) cylinder(r=2.5,h=10);
    translate([-11.77,-16.27,2]) cylinder(r=3.5,h=10);
